...
| Neutral-axis coupling | Nuclear + Topologist | 2 pro + 2 anti stable? Torque → Helium-4 BE (28.3 MeV)? | Within 10% | TBD | — | [Date] |
...
- **"Helium-4 binding from 2 pro + 2 anti: calculate it."**
  - Not just topology—**binding energy in MeV**
  - Must match **28.3 MeV within 10%** (or identify where the discrepancy comes from)
