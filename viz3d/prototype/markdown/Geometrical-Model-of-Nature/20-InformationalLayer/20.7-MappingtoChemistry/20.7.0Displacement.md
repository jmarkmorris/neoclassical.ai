...
Using the ideal gas law, dry air at 1 atm and 298 K contains ≈ $2.46 \times 10^{19}$ molecules per cm³. Multiplying by typical volume fractions gives:
- Nitrogen (N₂, 78.084%): ≈ $1.92 \times 10^{19}$ per cm³
- Oxygen (O₂, 20.946%): ≈ $5.16 \times 10^{18}$ per cm³
- Argon (Ar, 0.934%): ≈ $2.30 \times 10^{17}$ per cm³
- Carbon dioxide (CO₂, ~420 ppm): ≈ $1.03 \times 10^{16}$ per cm³
- Neon (Ne, 18.2 ppm): ≈ $4.5 \times 10^{14}$ per cm³
- Helium (He, 5.24 ppm): ≈ $1.29 \times 10^{14}$ per cm³
- Methane (CH₄, ~1.9 ppm): ≈ $4.7 \times 10^{13}$ per cm³
- Krypton (Kr, 1.14 ppm): ≈ $2.8 \times 10^{13}$ per cm³
- Hydrogen (H₂, 0.55 ppm): ≈ $1.35 \times 10^{13}$ per cm³
- Nitrous oxide (N₂O, ~0.336 ppm): ≈ $8.3 \times 10^{12}$ per cm³
- Xenon (Xe, 0.087 ppm): ≈ $2.1 \times 10^{12}$ per cm³
- Ozone (O₃, variable; e.g., 30 ppb): ≈ $7.4 \times 10^{11}$ per cm³

Notes:
- “Dry air” omits water vapor. At 25°C and 50% RH, H₂O is ~1.6% by volume (≈ $3.9 \times 10^{17}$ per cm³), reducing the dry-air constituents by the same fraction. At 100% RH (25°C), H₂O is ~3.1% (≈ $7.7 \times 10^{17}$ per cm³).
- At STP (0°C, 1 atm), total density ≈ $2.69 \times 10^{19}$ per cm³; scale species accordingly.
