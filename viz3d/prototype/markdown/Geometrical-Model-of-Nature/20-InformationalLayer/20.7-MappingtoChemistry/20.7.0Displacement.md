...
| Molecule    | Formula | VdW Volume ($\mathrm{\AA}^3$) |
| ----------- | ------- | --------------- |
| Hydrogen    | $H_2$   | 25              |
| Helium      | He      | 27              |
| Nitrogen    | $N_2$   | 34              |
...
*($1\ \mathrm{\AA}^3 = 10^{-24}\ \mathrm{cm}^3$)*

### How much volume do gas molecules actually occupy in air?

At everyday conditions ($\approx 1$ atm, room temperature), air is extremely sparse. A quick estimate using van der Waals volumes shows why:

- Take nitrogen ($N_2$) as representative with VdW volume $\approx 34\ \mathrm{\AA}^3$ per molecule. One mole then “hard-core” occupies about $34 \times 10^{-24}\ \mathrm{cm}^3 \times N_A \approx 20\ \mathrm{cm}^3$.
- One mole of an ideal gas occupies $\approx 24{,}000\ \mathrm{cm}^3$ at 298 K and 1 atm.
- Packing fraction $\approx 20\ \mathrm{cm}^3 / 24{,}000\ \mathrm{cm}^3 \approx 0.08$–0.1%.

Intuition scales:
- Average intermolecular spacing $\approx 3$–4 nm.
- Mean free path in air $\approx 60$–70 nm.
...
### Number densities in air (molecules per $\mathrm{cm}^3$, dry air at 1 atm and $25^\circ\text{C}$)

Using the ideal gas law, dry air at 1 atm and 298 K contains $\approx 2.46 \times 10^{19}$ molecules per $\mathrm{cm}^3$. Multiplying by typical volume fractions gives:
- Nitrogen ($N_2$, 78.084%): $\approx 1.92 \times 10^{19}$ per $\mathrm{cm}^3$
- Oxygen ($O_2$, 20.946%): $\approx 5.16 \times 10^{18}$ per $\mathrm{cm}^3$
- Argon (Ar, 0.934%): $\approx 2.30 \times 10^{17}$ per $\mathrm{cm}^3$
- Carbon dioxide ($CO_2$, ~420 ppm): $\approx 1.03 \times 10^{16}$ per $\mathrm{cm}^3$
- Neon (Ne, 18.2 ppm): $\approx 4.5 \times 10^{14}$ per $\mathrm{cm}^3$
- Helium (He, 5.24 ppm): $\approx 1.29 \times 10^{14}$ per $\mathrm{cm}^3$
- Methane ($CH_4$, ~1.9 ppm): $\approx 4.7 \times 10^{13}$ per $\mathrm{cm}^3$
- Krypton (Kr, 1.14 ppm): $\approx 2.8 \times 10^{13}$ per $\mathrm{cm}^3$
- Hydrogen ($H_2$, 0.55 ppm): $\approx 1.35 \times 10^{13}$ per $\mathrm{cm}^3$
- Nitrous oxide ($N_2O$, ~0.336 ppm): $\approx 8.3 \times 10^{12}$ per $\mathrm{cm}^3$
- Xenon (Xe, 0.087 ppm): $\approx 2.1 \times 10^{12}$ per $\mathrm{cm}^3$
- Ozone ($O_3$, variable; e.g., 30 ppb): $\approx 7.4 \times 10^{11}$ per $\mathrm{cm}^3$

Notes:
- “Dry air” omits water vapor. At $25^\circ\text{C}$ and 50% RH, $H_2O$ is ~1.6% by volume ($\approx 3.9 \times 10^{17}$ per $\mathrm{cm}^3$), reducing the dry-air constituents by the same fraction. At 100% RH ($25^\circ\text{C}$), $H_2O$ is ~3.1% ($\approx 7.7 \times 10^{17}$ per $\mathrm{cm}^3$).
- At STP ($0^\circ\text{C}$, 1 atm), total density $\approx 2.69 \times 10^{19}$ per $\mathrm{cm}^3$; scale species accordingly.
...
1. **Geometric VdW Volume (constant)**
   ...
   * Methane, for instance, is \~71 $\mathrm{\AA}^3$ regardless of conditions.
