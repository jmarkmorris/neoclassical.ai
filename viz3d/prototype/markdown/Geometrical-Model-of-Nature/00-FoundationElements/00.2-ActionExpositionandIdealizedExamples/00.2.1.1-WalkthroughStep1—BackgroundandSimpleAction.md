...
>
> Geodesics and dynamics: The background is fixed (absolute time $\times$ Euclidean space); free paths are straight. Accelerations come only from delayed, purely radial hits from emitted shells—never from background curvature.
