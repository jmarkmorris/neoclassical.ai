...
- Kinematics and path:
  - Group velocity $\approx v$ (1 in our units); no rest frame (apparent rest energy is zero).
...
Plain language: A photon is a neutral, phase-locked “train” of planar pushes guided down a narrow tube; polarizers simply project that tube’s sideways wiggle (giving $\cos^2\theta$), and making or absorbing a photon is the tube locking onto or peeling off an internal rotating pair.
