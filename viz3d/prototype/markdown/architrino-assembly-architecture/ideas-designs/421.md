...
**Detail Table (1:2:4 lock across the full range; $v_k = \beta(f_k)c_f$):**
...
| $4f_P$ | $2f_P$ | $f_P$ | $\dfrac{\beta(4f_P)\,c_f}{8\pi f_P}$ | $\dfrac{\beta(2f_P)\,c_f}{4\pi f_P}$ | $\dfrac{\beta(f_P)\,c_f}{2\pi f_P}$ | $\beta(4f_P)\,c_f$ | $\beta(2f_P)\,c_f$ | $\beta(f_P)\,c_f$ |
