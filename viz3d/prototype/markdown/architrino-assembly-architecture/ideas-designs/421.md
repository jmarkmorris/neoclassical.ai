...
Take the horizon state as the reference: Outer and Middle ride $c_f$ (our hinge), while the Inner is already in the self-hit regime at the low-frequency floor with $v_I = \beta c_f$, $\beta>1$. As $f_O$ increases, $\beta$ grows within the self-hit region and is capped at the universal MCB value $\beta_{\text{MCB}}>1$. With the 1:2:4 lock,
$$
