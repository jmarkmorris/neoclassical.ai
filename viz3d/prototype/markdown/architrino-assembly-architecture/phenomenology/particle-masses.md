...
- The 125 GeV "Higgs Boson" is reinterpreted as a **radial breathing mode** of the sea lattice, not the source of mass itself (see `assemblies/bosons/electroweak-bosons.md`).
...
1. **Far-Field Potential Calculation**:
   - Use the Master Equation (`dynamics/master-equation.md`) to compute the net potential field at large distances from a tri-binary assembly.
