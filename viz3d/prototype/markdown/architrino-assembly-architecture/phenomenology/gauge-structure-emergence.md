...
## 18.1 The Physical Substrate: From Vacuum to "Noether Sea"
...
## 18.3 Symmetry Groups as Geometric Deformations
...
## 18.5 Resolving the Unruh Ambiguity
...
## 18.6 Quantization from Stability (Selection Rules)

Why are charges quantized? Why $1/3, 2/3, 1$?
*   The Standard Model asserts this; AAA derives it.
*   **Stability Selection:** The Absolute Observer sees that arbitrary clusters of $|e/6|$ charges are unstable. They either collapse (self-hit singularity) or fly apart.
