...
| Maximal Curvature Binary (MCB) | No analogue in standard models. | Electrino-positrino pair stabilized at minimum radius via self-hit in \(v>c_f\) regime; defines prototype length/time. |
...
| Tri-Binary | No tri-binary assembly; bound states described by quantum fields and forces. | Three nested binaries (inner, middle, outer) with separated radii/frequencies; building block for particles. |
