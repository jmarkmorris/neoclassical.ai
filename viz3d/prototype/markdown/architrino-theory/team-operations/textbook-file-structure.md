...
├── CHANGELOG.md                       # Track major updates, decisions, pivots
│
├── foundations/                       # Part I-II material
│   ├── README.md                      # Overview of foundational commitments
│   ├── ontology.md                    # What exists (architrinos, void, time)
│   ├── absolute-time-defense.md       # Why absolute time, how to reconcile with SR
│   ├── euclidean-void.md              # What is the substrate?
│   ├── master-equation.md             # The fundamental dynamics
│   ├── self-hit-dynamics.md           # Conceptual + technical overview
│   ├── validation-protocols.md        # How we test/verify claims
│   └── parameter-ledger.md            # Categories A/B/C/D (fundamental vs fitted)
│
├── assemblies/                        # Part III material
│   ├── README.md
│   ├── binary-dynamics.md
...
│   ├── assembly-atlas.md              # Catalog of known stable configurations
│   └── velocity-regimes.md            # v<c_f, v=c_f, v>c_f
│
├── particle-physics/                  # Part IV material
│   ├── README.md
│   ├── charge-quantization.md
│   ├── spin-statistics-derivation.md
│   ├── fermion-mapping.md             # Electrons, quarks, neutrinos
│   ├── boson-mapping.md               # Photons, W/Z, gluons, Higgs
│   ├── gauge-structure-emergence.md
│   ├── particle-masses.md
│   └── precision-tests.md             # g-2, alpha, etc.
│
├── nuclear-atomic/                    # Part V material
│   ├── README.md
│   ├── nuclear-binding.md
│   ├── atomic-spectra.md
...
│   └── eos-dense-matter.md
│
├── quantum-interpretation/            # Part VI material
│   ├── README.md
│   ├── pilot-wave-character.md
│   ├── measurement-ontology.md
│   ├── superposition-mechanism.md
│   ├── entanglement-nonlocality.md
│   ├── bell-theorem-loophole.md
│   └── collapse-problem.md
│
├── gravity-spacetime/                 # Part VII material
│   ├── README.md
│   ├── emergent-metric.md
│   ├── proper-time-derivation.md
│   ├── ppn-parameters.md
│   ├── gw-phenomenology.md
│   ├── singularity-resolution.md
│   └── hierarchy-problem.md
│
├── cosmology/                         # Part VIII material
│   ├── README.md
│   ├── expansion-mechanism.md
│   ├── inflation-model.md
│   ├── cmb-predictions.md
│   ├── bbn-constraints.md
│   ├── structure-formation.md
│   ├── h0-tension.md
│   └── failure-modes.md
│
├── simulations/                       # Part X material
│   ├── README.md
│   ├── tier1-architrino-dynamics.md
│   ├── tier2-binary-formation.md
│   ├── tier3-tri-binary-stability.md
│   ├── tier4-continuum-limit.md
│   ├── convergence-tests.md
│   ├── run-protocols.md
│   └── synthetic-observables.md
│
├── philosophy-history/                # Parts IX, XI material
│   ├── README.md
│   ├── historical-context.md          # Ether theories, pilot-wave, emergent gravity
│   ├── lorentz-ether-comparison.md
│   ├── no-go-theorems.md              # Bell, Coleman-Mandula, Weinberg-Witten, etc.
│   ├── theory-virtues.md              # Parsimony, depth, testability
│   ├── explanatory-scoreboard.md
│   └── open-questions.md
│
├── adversarial/                       # Red team / critique material
│   ├── README.md
│   ├── constraint-ledger.md           # Tier 1-2-3 observational constraints
│   ├── failure-criteria.md
│   ├── stop-conditions.md
│   ├── parameter-count-audit.md
│   └── theory-health-dashboard.md
│
├── team-operations/                   # Team charter, role definitions, workflows
│   ├── README.md
│   ├── team-charter.md
│   ├── role-definitions/
│   │   ├── phil.md
...
│   │   ├── sig.md
│   │   └── red.md
│   ├── governance.md                  # Decision rules, stop conditions
│   ├── communication-standards.md
│   └── quarterly-review-template.md
│
└── appendices/
    ├── glossary.md                    # (symlink or copy of top-level GLOSSARY.md)
    ├── notation.md
    ├── units-conventions.md
    ├── mathematical-tools.md
    └── references.md
```
...
- **Document heading**: `# Deriving Proper Time from Absolute Time: The $\tau \leftrightarrow t$ Map in Emergent Spacetime`
