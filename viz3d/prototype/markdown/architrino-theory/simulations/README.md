...
- “What experiments see” is generated by post-processing: embed detector assemblies with worldlines X_det(t), compute $\tau_{\text{det}}(t)$, and generate detector-like logs.

Checklist per tier:
- What VO records ($\Phi$, $\nabla\Phi$, medium vars, provenance)
