# this will be an animation about how I visualize architrinos, their emissions, their paths, the action, you name it. 

# everything about a architrino

# start with the Euclidean void they occupy.  We expect very little from it.

# when I get to architrino emissions, somehow illustrate that it is a constant flowing potential that you can thing of several ways.
...
# even though only intersections with architrinos matter
...
# do architrinos receive or consume potential when action takes place? If they do it would also be q/v for balance.
