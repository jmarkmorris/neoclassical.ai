...
Add to the “Explanatory Scoreboard”:
...
- **Relativity of Simultaneity**
  ...
  - *Architrino*: Absolute time gives a unique global 'now' for the virtual observer; relativity of simultaneity is emergent from how assembly clocks and signals behave in the medium, not fundamental ontology.

For each of these, score the architrino framework on:
- Clarity of micro‑ontology,
- Ability to reproduce known phenomena,
- Presence of new, testable predictions (e.g. Lorentz deviations in extreme regimes).
