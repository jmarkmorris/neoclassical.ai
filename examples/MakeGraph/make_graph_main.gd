...
func create_axes() -> void:
	...
	var x_min = -10.0
	var x_max = 10.0
	var y_min = -4.5 # Extended y-axis lower bound for 4x stretch
	var y_max = 4.5 # Extended y-axis upper bound for 4x stretch
	...
	y_label.position = Vector3(0.3, 4.8, 0) # Adjusted position for new y_max
...
func create_vertical_line() -> void:
	# Create vertical line at x=2π
	var y_min = -4.5 # Use the extended limits matching create_axes
	var y_max = 4.5 # Use the extended limits matching create_axes
...
func create_labels() -> void:
	...
	line_label.position = Vector3(TAU, 4.8, 0) # Centered near top of line
