# manim % manim -pqh --disable_caching lorenz_attractor.py Lorenz -p
# this uses grant's manim not manimce.  So it doesn't work for me.  Perhaps I could set up grant's environment?
